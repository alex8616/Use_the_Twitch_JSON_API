  ...
  channels.forEach(function(channel) {
    ...
    $.getJSON(makeURL("streams", channel), function(data) {
      ...
      $.getJSON(makeURL("channels", channel), function(data) {
        var logo = data.logo != null ? data.logo : "",
          name = data.display_name != null ? data.display_name : channel,
          description = status === "online" ? ': ' + data.status : "https://dummyimage.com/50x50/ecf0e7/5c5457.jpg&text=0x3F";
          html = '<div class="row ' + 
          status + '"><div class="col-xs-2 col-sm-1" id="icon"><img src="' + 
          logo + '" class="logo"></div><div class="col-xs-10 col-sm-3" id="name"><a href="' + 
          data.url + '" target="_blank"><br>' + 
